...
const config = {
  ...
  urls: {
    ...
    imgForOccasionalClients: 'https://tkachuks.github.io/GitHubPage/dist/media/images/',
    defaultPathToWorkerImg: 'https://tkachuks.github.io/GitHubPage/dist/media/images/',
    defaultPathToClientImg: 'https://tkachuks.github.io/GitHubPage/dist/media/images/',
    appointmentsUrl: `${baseUrl}/appointments`,
    waze: 'https://waze.com/ul?q={address}',
    menu_icons: 'https://tkachuks.github.io/GitHubPage/dist/menu/',
    startUrl: '/en/calendar',
    staticImg: 'https://tkachuks.github.io/GitHubPage/dist/media',
    clientPage: '/clients',
    sendSmS: '/send-sms',
    login: '/login'
  },
